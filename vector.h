...
public:
    ...
    vector(size_t allocation_size)
    {
        *this = vector(allocation_size, T());
    }
    vector(size_t allocation_size, const T &initial_value)
    {
...
public:
    ...
    */
    ...
    T &operator*()
    {
        ...
        {
            throw std::out_of_range("Dereferencing an out-of-range iterator.");
        }
        return *pointer;
    }
